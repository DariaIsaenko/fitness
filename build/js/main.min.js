...
var choicePrices = document.querySelectorAll('.choice-subscription__price');
var choiceButtons = document.querySelectorAll('.choice-month__button');
var pricesBlocks = document.querySelectorAll('.choice-subscription__prices');
...
function showPrices(element) {
  choicePrices.forEach(function (choicePrice) {
